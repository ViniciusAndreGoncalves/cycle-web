...
export function Profile() {
  ...
  async function handleUpdate(e: React.FormEvent) {
    ...
    try {
      ...
      setFormData(prev => ({ ...prev, password: "", password_confirmation: "" })) // Limpa campos de senha
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <Card className="bg-zinc-900 border-zinc-800 mb-8">
          <CardHeader>
            ...
            <CardDescription>Atualize suas informações e credenciais.</CardDescription>
          </CardHeader>
        ...
        <Card className="border-red-900/50 bg-red-950/10">
          <CardHeader>
            ...
            <CardDescription className="text-red-400/70">
              Essas ações são irreversíveis. Ao excluir sua conta, todos os seus dados de carteira serão perdidos.
            </CardDescription>
          </CardHeader>
          <CardFooter className="justify-end">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="bg-zinc-900 border-zinc-800 text-white">
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel className="bg-zinc-800 border-zinc-700 hover:bg-zinc-700 text-white">Cancelar</AlertDialogCancel>
